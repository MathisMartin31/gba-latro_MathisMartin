...
void game_options_menu_change_background(void)
{
    ...
    // TODO remove
    const char* TOTO = TTE_YELLOW_TAG "This should show up formatted" TTE_BLUE_TAG " This is blue " TTE_YELLOW_TAG "but the rest isn't " TTE_BLUE_TAG "Blue blue bluuuue";
